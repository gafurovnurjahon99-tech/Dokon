...
// 2. SOZLAMALAR (To'g'rilangan Firebase Config)
...
// Firebase initialization (Agar mavjud bo'lsa qayta boshlamaslik uchun)
...
function updateStats() {
    database.ref('orders').on('value', s => {
        ...
        if (revEl) revEl.innerText = rev.toLocaleString() + " so'm";
