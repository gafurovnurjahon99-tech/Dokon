...
// 2. SOZLAMALAR (Sizning ma'lumotlaringiz joylandi)
...
const ADMIN_TELEGRAM_ID = 7577685281; // Sizning shaxsiy ID raqamingiz
const ADMIN_CHAT_ID = "7577685281";   // Buyurtma boradigan manzil
...
function sendOrderToTelegram() {
    ...
    fetch(`https://api.telegram.org/bot${BOT_TOKEN}/sendMessage`, {
        ...
        body: JSON.stringify({
            ...
            reply_markup: {
                inline_keyboard: [[
                    { text: "📞 Bog'lanish", url: `tg://user?id=${user ? user.id : ''}` },
        ...
        if(res.ok) {
            tg.showAlert("Rahmat! Buyurtmangiz yuborildi.");
            cart = {};
            ...
            tg.showAlert("Xato! Bot hali sizga yozmagan bo'lishi mumkin.");
        }
    });
}

// --- QOLGAN UI VA ADMIN FUNKSIYALARI ---
...
function addNewProduct() {
    ...
    } else { alert("Ma'lumot to'liq emas!"); }
}
